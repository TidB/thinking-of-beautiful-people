...
@onready var node_viewport = $RoomPlayer/Desk/SubViewport
@onready var node_quad = $RoomPlayer/Desk/MeshInstance3D6/ViewportQuad
@onready var node_area = $RoomPlayer/Desk/MeshInstance3D6/ViewportQuad/Area3D
